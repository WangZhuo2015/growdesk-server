...
func nativeVaccineEngineRules() []Object {
	return []Object{
		...
		{"id": "rule_pentaxim_no_auto_same_day", "type": "coadministration_constraint", "vaccineIds": []string{"vac_dtap_ipv_hib_pentaxim"}, "description": "潘太欣中国说明书暂建议不与其他儿童计划免疫/常规儿童疫苗同时接种；自动排期不得默认同日。", "sourceRefs": []string{"src_pentaxim_pi_2024"}},
